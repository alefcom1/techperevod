...
const { Button, Card, FileDropzone, Badge, Icon, ProductWindow } = window.TechperevodDesignSystem_4028dd;
      ...
      <div className="tp-hero__inner">
        <div className="tp-hero__copy">
          ...
          <p className="tp-hero__subtitle">
            Документ переводит связка из нескольких AI-моделей и инженера с профильным
            образованием — а оценку объёма и срока вы получите уже через 2 минуты после загрузки.
          </p>
          <div className="tp-hero__ctas">
            <Button size="lg" variant="primary" onClick={() => document.getElementById("quote").scrollIntoView({ block: "center" })}>
              Загрузить документ
            </Button>
        ...
        <div className="tp-hero__visual">
          <ProductWindow url="app.techperevod.com/orchestrator">
            ...
            <div className="tp-queue-row">
              ...
              <Badge tone="primary" size="sm">Claude</Badge>
