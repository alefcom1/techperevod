...
const ICONS: Record<string, IconChild[]> = {
  ...
  "flask-conical": [
    [
      "path",
      {
        d: "M14 2v6a2 2 0 0 0 .245.96l5.51 10.08A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-3l5.51-10.08A2 2 0 0 0 10 8V2",
      },
    ],
  ...
  car: [
    [
      "path",
      {
        d: "M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9L2 10.5V16c0 .6.4 1 1 1h2",
      },
    ],
  ...
  plane: [
    [
      "path",
      {
        d: "M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-1 .1-1.3.5l-.7.9c-.6.7-.5 1.7.2 2.3L9 15l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 5.2 6.3c.6.6 1.6.8 2.3.2l.9-.7c.4-.3.6-.8.5-1.3z",
      },
    ],
  ],
};
