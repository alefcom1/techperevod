...
/**
 * Drag-and-drop file target that drives the "instant quote" flow — the hero's
 * central interaction. Purely presentational; wire onFiles to your own
 * upload/estimate logic.
 */
  ...
  return (
    ...
    >
      <input
        ...
        accept={accept}
        hidden
        onChange={(e) => onFiles && e.target.files && e.target.files.length && onFiles(e.target.files)}
      />
