 ...
 * connected by radiating lines with a turquoise pulse travelling outward.
 */
export function HeroModelDiagram({ models = DEFAULT_MODELS, className = "" }: HeroModelDiagramProps) {
  const size = 420;
  const c = size / 2;
  const ringR = 150;
          ...
          return (
            <line
              ...
              className={
                ...
                (m.kind === "local" ? "tp-orchestrator__line--local" : "tp-orchestrator__line--western")
              }
