...
export const TRANSLATOR_STEPS: TranslatorStep[] = [
  {
    iconName: "file-text",
    title: "Анкета",
    description: "Заполняете анкету, указываете языковые пары, при желании прикладываете диплом или сертификат.",
    bullets: ["Языковые пары и уровень владения", "Диплом/сертификат — необязательно"],
  },
  {
    iconName: "user-check",
    title: "Проверка редактором",
    description: "Наш редактор смотрит анкету, при необходимости уточняет детали.",
