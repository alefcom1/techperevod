...
const BEFORE_AFTER: Record<string, { before: string; after: string }> = {
  ...
  "perevod-patentov": {
    before:
      "Устройство содержащее корпус, зажим предназначенный для крепления детали и датчик соединенный с зажимом для измерения усилие.",
    after:
      "Устройство, содержащее корпус, крепёжный элемент, выполненный с возможностью фиксации детали, и датчик, соединённый с крепёжным элементом и предназначенный для измерения усилия.",
  },
};
