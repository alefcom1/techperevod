  ...
  return (
    <>
      ...
      <PageHero
        ...
        badge={<Badge tone="accent">Несколько примеров из многих клиентов</Badge>}
        ...
        <div className="tp-section__inner">
          <ScrollReveal>
            <p className="tp-service-intro">
              Мы работаем с гораздо большим числом компаний — в машиностроении, нефтегазе, строительстве, IT,
              медтехе и других отраслях. Здесь — несколько историй сотрудничества, которые показываем открыто:
              реальные клиенты платформы, а не абстрактные примеры. Мы намеренно не приводим цифры и детали,
              которые нам не подтверждали сами компании — только то, что описывает суть многолетней работы.
            </p>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section className="tp-section tp-section--tint">
        <div className="tp-section__inner">
          <ScrollReveal>
            <SectionHeader
              title="Истории сотрудничества"
              subtitle="Семь примеров из значительно большего числа компаний, с которыми мы работаем."
            />
          </ScrollReveal>
