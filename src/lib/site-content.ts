...
export const DEFAULT_CONTENT: SiteContent = {
  meta: {
    ...
    "o-nas": {
      title: "О нас",
      description:
        "Техперевод — платформа технического перевода: AI-оркестрация моделей плюс редактура инженеров-переводчиков. Скорость AI, точность инженера.",
    },
    blog: {
      title: "Блог",
      description:
    ...
    kontakty: {
      title: "Контакты",
      description:
        "Свяжитесь с Техперевод: email, телефон, Telegram. Оставьте заявку и прикрепите документ — пришлём оценку стоимости в течение рабочего дня.",
    },
    perevodchik: {
    ...
    "product/api": {
      ...
      description:
        "REST API платформы Техперевод: перевод текста и документов из вашего кода, с оркестрацией моделей и термбазой. Доступен на тарифах «Про» и «Бизнес».",
    },
    otrasli: {},
  },
  home: {
  ...
  tarify: {
    ...
    plans: {
      free: { name: "Бесплатный", price: "0 ₽", per: "", desc: "Мгновенный перевод фрагментов — попробовать качество." },
      start: { name: "Старт", price: "2 900 ₽", per: "/мес", desc: "Для специалистов и небольших команд." },
      pro: { name: "Про", price: "9 900 ₽", per: "/мес", desc: "Для команд с постоянным потоком документации." },
      business: { name: "Бизнес", price: "по договору", per: "", desc: "Объёмы, SLA и интеграции под ваш процесс." },
    },
  },
};
